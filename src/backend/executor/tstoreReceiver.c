...
{
	/***** Yahya's Addition ****/
	ereport(LOG, (errmsg("THIS IS tStoreReceiver - PREPARE!!")));
...
{
	/***** Yahya's Addition ****/
	ereport(LOG, (errmsg("THIS IS tStoreReceiver - RECEIVE FROM EXCTR AND STORE - NOTOAST!!")));
...
{
	/***** Yahya's Addition ****/
	ereport(LOG, (errmsg("THIS IS tStoreReceiver - RECEIVE FROM EXCTR AND STORE - DETOAST!!")));
